...
var settings = {
	...
	time_dl_max: 0, // max duration of download test in seconds
	...
	xhr_ul_blob_megabytes: 4, //size in megabytes of the upload blobs sent in the upload test (forced to 4 on chrome mobile)
